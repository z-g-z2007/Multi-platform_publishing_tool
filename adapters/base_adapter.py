...
from .plugin_interface import PlatformInfo
...
class BaseAdapter(ABC):
    ...
    platform_icon_url = ''   # 平台图标URL
    platform_description = ''  # 平台描述
    platform_color = '#333333'  # 平台主题色
    ...
    def adapt(self, title: str, content: str, images: list = None) -> dict:
        ...
        return {
            ...
            'platform_icon': self.platform_icon_url or self.platform_icon,
